...
import kotlinx.android.synthetic.main.activity_share_ride.view.*
import kotlinx.android.synthetic.main.activity_view_rides.*
import kotlinx.android.synthetic.main.activity_view_rides.view.*
...
class ViewRides : AppCompatActivity() {
        ...
        public class MyRecyclerAdapter (private val rides: ArrayList<Ride>) : RecyclerView.Adapter<MyRecyclerAdapter.myViewHolder>() {
            ...
            inner class myViewHolder(v: View) : RecyclerView.ViewHolder(v), View.OnClickListener
            {
                        ...
                        fun bindRide(ride: Ride) {
                            ...
                            //textkm = find
                            view.textViewTkm.text = "Total Distance ${ride.TotalDistance}"
                            view.textViewTFare.text = "Total Fare ${ride.TotalFare}"
                            view.textViewNoRiders.text = "No. of Riders ${ride.NoofRiders}"
                            view.textViewuid.text = ride._ID
                            println("ride id ${ride._ID}")

                            if ( ride.rideDate != null)
                            {
                                view.textViewdate.text = date_text(ride.rideDate as Date)
                            }

                            if (ride.RideDescr != null)
                            {
                                view.textViewDescr.text = ride.RideDescr
                            }

                            view.textViewRiders.text = riders_text(ride.Riders)
